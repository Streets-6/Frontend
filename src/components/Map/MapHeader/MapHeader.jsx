  ...
  return (
    <div
      className={`${styles.mapHeader} ${
        isMapHeaderVisible ? styles.mapHeader_opened : ''
      }`}
    >
      ...
      <div className={styles.mapHeader__chairmain}>
        ...
        <div className={styles.mapHeader__chairmanInfo}>
          ...
          <span className={styles.mapHeader__jobTitle}>
            {data?.chairman.jobTitle}
          </span>
          <div className={styles.mapHeader__textGroup}>
            <span
              className={`${styles.mapHeader__contact} ${styles.mapHeader__phone}`}
            >
              {formatPhoneNumber(data?.chairman.phoneNumber)}
            </span>
            <span
              className={`${styles.mapHeader__contact} ${styles.mapHeader__email}`}
            >
              {data?.chairman.email}
            </span>
          </div>
          <a
            className={`${styles.mapHeader__link}`}
