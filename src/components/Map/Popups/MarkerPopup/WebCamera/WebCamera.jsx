      ...
      <div className={styles.webCamera__header}>
        <div className={styles.webCamera__textWrapper}>
          ...
          <p className={styles.webCamera__description}>
            Смотрите заранее занятость площадки, а также демонстрируйте свои
            умения друзьям и знакомым из других городов в режиме онлайн
          </p>
        </div>
      </div>
      <div className={styles.webCamera__streamWrapper}>
        <iframe
