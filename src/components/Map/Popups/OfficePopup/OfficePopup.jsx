    ...
    <BasePopup>
      <div className={styles.officePopup}>
        <div className={styles.officePopup__header}>
          ...
          <h3 className={styles.officePopup__title}>{selectedRegion?.info?.title}</h3>
        </div>
        <div className={styles.officePopup__chairmain}>
          ...
          <div className={styles.officePopup__chairmanInfo}>
            ...
            <div className={styles.officePopup__textGroup}>
              ...
              <span className={`${styles.officePopup__contact} ${styles.officePopup__phone}`}>
                {formatPhoneNumber(selectedRegion?.info?.chairman.phoneNumber)}
              </span>
              <span className={`${styles.officePopup__contact} ${styles.officePopup__email}`}>
        ...
        {selectedRegion?.infrastructure && selectedRegion?.infrastructure?.length > 0 && (
          <button
        ...
        {selectedRegion?.events && selectedRegion?.events?.length > 0 && (
          ...
          >
            <span className={`${styles.officePopup__buttonText} ${styles.officePopup__event}`}>
              События
            </span>
            <span className={styles.officePopup__markersCount}>
