...
export const getInfrastructure = (state: RootState) => state.infrastructure.infrastructureArray;
export const getInfrastructureIsLoaded = (state: RootState) => state.infrastructure.isSuccess;
