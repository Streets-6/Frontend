...
const map = createSlice({
  ...
  reducers: {
    ...
    setIsInfrastructureMarkersVisible: (state, action: PayloadAction<boolean>) => {
    ...
    setIsInfrastructureButtonClicked: (state, action: PayloadAction<boolean>) => {
...
export const getIsMapDefaultView = (state: RootState) => state.map.isMapDefaultView;
export const getIsOfficePopupOpen = (state: RootState) => state.map.isOfficePopupOpen;
export const getIsMarkerPopupOpen = (state: RootState) => state.map.isMarkerPopupOpen;
export const getIsMapHeaderVisible = (state: RootState) => state.map.isMapHeaderVisible;
export const getIsInfrastructureMarkersVisible = (state: RootState) =>
  state.map.isInfrastructureMarkersVisible;
export const getIsEventMarkersVisible = (state: RootState) => state.map.isEventMarkersVisible;
export const getIsInfrastructureButtonClicked = (state: RootState) =>
  state.map.isInfrastructureButtonClicked;
export const getIsEventButtonClicked = (state: RootState) => state.map.isEventButtonClicked;
export const getContentTypeFilter = (state: RootState) => state.map.contentTypeFilter;
export const getDisciplineFilter = (state: RootState) => state.map.disciplineFilter;
